...
class ConfigStore {
    ...
    static Write(path, config) {
        text := "[Paths]`n"
            ...
            . "NewNote=" config.NewNoteHotkey "`n"
            . "NormalEnabled=" config.NormalEnabled "`n"
            . "TodoEnabled=" config.TodoEnabled "`n"
            . "NewNoteEnabled=" config.NewNoteEnabled "`n`n"
            . "[NewNote]`n"
            . "LinkInFlashNote=" config.LinkNewNoteInFlash "`n`n"
            . "[SourceUrl]`n"
